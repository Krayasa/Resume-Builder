      ...
      <div className="prose prose-sm prose-zinc max-w-full dark:prose-invert">
        <p>
          <Trans>
            ...
            to disable the AI features in Refobe Resume altogether, you can simply remove the key
            from your settings.
          </Trans>
        </p>
      </div>
      ...
      <Alert variant="warning">
        <div className="prose prose-neutral max-w-full text-xs leading-relaxed text-primary dark:prose-invert">
          <Trans>
            ...
            outlined by OpenAI. Please note that Refobe Resume bears no responsibility for any
