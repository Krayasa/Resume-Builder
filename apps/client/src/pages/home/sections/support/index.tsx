...
export const SupportSection = () => (
  ...
  >
    <div className="container space-y-6">
      <h1 className="text-4xl font-bold">{t`Supporting Refobe Resume`}</h1>

      <p className="max-w-4xl leading-loose">
        {t`Refobe Resume is a free and open-source project crafted mostly by me, and your support would be greatly appreciated. If you're inclined to contribute, and only if you can afford to, consider making a donation through any of the listed platforms. Additionally, donations to Refobe Resume through Open Collective are tax-exempt, as the project is fiscally hosted by Open Collective Europe.`}
      </p>
      ...
      <p className="max-w-4xl leading-loose">
        {t`Even if you're not in a position to contribute financially, you can still make a difference by giving the GitHub repository a star, spreading the word to your friends, or dropping a quick message to let me know how Refobe Resume has helped you. Your feedback and support are always welcome and much appreciated!`}
      </p>
    </div>
  </section>
);
