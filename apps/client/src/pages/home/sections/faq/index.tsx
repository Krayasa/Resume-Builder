...
// Who are you, and why did you build Refobe Resume?
const Question1 = () => (
  <AccordionItem value="1">
    ...
    <AccordionContent className="prose max-w-none dark:prose-invert">
      ...
      <p>
        ...
        to build the first version of Refobe Resume in 2019. Since then, it's gone through
        multiple iterations as I've learned a lot of better coding practices over the years.
      </p>

      <p>
        At the time of writing, Refobe Resume is probably one of the only handful of resume
      ...
      <p>
        ...
        basis, and I'm extremely proud to say that Refobe Resume, over it's years of development,
...
// How much does it cost to run Refobe Resume?
const Question2 = () => (
  <AccordionItem value="2">
    ...
    <AccordionContent className="prose max-w-none dark:prose-invert">
      <p>
        ...
        graciously sponsored their infrastructure to allow me to host Refobe Resume on their
  ...
  <AccordionItem value="3">
    ...
    <AccordionContent className="prose max-w-none dark:prose-invert">
      ...
      <p>
        ...
        that's wishful thinking. But if you do mention Refobe Resume on your blog, let me know so
...
// What languages are supported on Refobe Resume?
const Question4 = () => {
  ...
  return (
    <AccordionItem value="4">
      ...
      <AccordionContent className="prose max-w-none dark:prose-invert">
        <p>
          Here are the languages currently supported by Refobe Resume, along with their respective
  ...
  <AccordionItem value="5">
    ...
    <AccordionContent className="prose max-w-none dark:prose-invert">
      <p>
        ...
        me in my everyday work and with the development of Refobe Resume. It only makes sense that
      ...
      <p>
        ...
        Refobe Resume has to offer. I would even suggest you to take the extra step of using
        ChatGPT to write your content, and simply copy it over to Refobe Resume.
      </p>
    </AccordionContent>
  </AccordionItem>
);
    ...
    <div className="grid gap-12 lg:grid-cols-3">
      <div className="space-y-6">
        ...
        <p className="text-base leading-loose">
          Here are some questions I often get asked about Refobe Resume.
        </p>
