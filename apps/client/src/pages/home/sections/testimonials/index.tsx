  ...
  [
    {
      name: "N. Elnour",
      quote:
        "This is really a thank you for Refobe Resume. Drafting resumes was never a strength of mine, so your app really made the whole process easy and smooth!",
    },
    {
      name: "S. Bhaije",
      quote:
  ...
  [
    {
      name: "A. Rehman",
      quote:
        "Hey Amruth, I have loved your Refobe Resume Website. Thank you so much for making this kind of thing.",
    },
    {
      name: "S. Innocent",
      quote:
        "First of all, I appreciate your effort for making Refobe Resume a free tool for the community. Very much better than many premium resume builder...",
    },
    {
      name: "M. Fritza",
      quote:
  ...
  <section id="testimonials" className="container relative space-y-12 py-24 sm:py-32">
    <div className="space-y-6 text-center">
      ...
      <p className="mx-auto max-w-2xl leading-relaxed">
        <Trans>
          I always love to hear from the users of Refobe Resume with feedback or support. Here are
